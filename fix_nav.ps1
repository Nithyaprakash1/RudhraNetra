...
foreach ($file in $htmlFiles) {
    ...
    $content = $content -replace '<span class="w-\[1px\] h-5 md:h-8 bg-\[#8B4513\]/30 block"></span>', '<span class="w-[1px] h-5 md:h-8 bg-[#8B4513]/30 block shrink-0"></span>'
...
Write-Host "Navbar updates applied to all HTML files."
